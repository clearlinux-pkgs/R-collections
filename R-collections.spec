...
Version  : 0.3.4
Release  : 10
URL      : https://cran.r-project.org/src/contrib/collections_0.3.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/collections_0.3.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595866847
