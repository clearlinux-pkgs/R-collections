...
Version  : 0.2.4
Release  : 1
URL      : https://cran.r-project.org/src/contrib/collections_0.2.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/collections_0.2.4.tar.gz
Summary  : High Performance Container Data Types
Group    : Development/Tools
License  : MIT
Requires: R-collections-lib = %{version}-%{release}
Requires: R-xptr
BuildRequires : R-xptr
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582072533
