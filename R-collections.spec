...
Version  : 0.3.2
Release  : 7
URL      : https://cran.r-project.org/src/contrib/collections_0.3.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/collections_0.3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591113197
