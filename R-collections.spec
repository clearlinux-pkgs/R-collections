...
Version  : 0.3.3
Release  : 8
URL      : https://cran.r-project.org/src/contrib/collections_0.3.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/collections_0.3.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592412980
